      ...
      <div className="container">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="border-2 border-muted shadow-sm">
            <CardHeader>
              <CardTitle>Official License Application</CardTitle>
              <CardDescription>
                    ...
                    >
                      <div className={`border rounded-lg p-4 ${selectedLevel === '1' ? 'border-primary bg-primary/5' : ''}`}>
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <Label htmlFor="tier1" className="font-semibold">Tier 1 - Individual Trader</Label>
                      ...
                      <div className={`border rounded-lg p-4 ${selectedLevel === '2' ? 'border-primary bg-primary/5' : ''}`}>
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <Label htmlFor="tier2" className="font-semibold">Tier 2 - Advanced Trader</Label>
                      ...
                      <div className={`border rounded-lg p-4 ${selectedLevel === '3' ? 'border-primary bg-primary/5' : ''}`}>
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <Label htmlFor="tier3" className="font-semibold">Tier 3 - Institutional</Label>
